...
export function AppSidebar() {
  ...
  return (
    <div className="fixed md:relative left-0 top-14 md:top-0 bottom-0 w-[280px] md:w-64 bg-sidebar border-r border-sidebar-border z-40 flex flex-col overflow-hidden safe-area-left">
